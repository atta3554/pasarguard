...
const Card = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: cn("rounded-md border bg-card text-card-foreground shadow", className), ...props }));
...
const CardTitle = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: cn("font-medium leading-none tracking-tight", className), ...props }));
...
//# sourceMappingURL=card-5ZQOfa_i.js.map
