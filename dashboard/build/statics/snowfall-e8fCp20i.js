...
function Snowfall({ className = "" }) {
  if (!isChristmasPeriod()) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `snowfall ${className}`, "aria-hidden": "true", children: snowflakes.map((flake, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "snowfall__sway", children: flake.type === "dot" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "snowfall__dot" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "snowfall__icon", viewBox: "0 0 321.493 321.493", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: snowflakePath }) }) })
    },
    `${flake.type}-${index}`
  )) });
}
...
//# sourceMappingURL=snowfall-e8fCp20i.js.map
